...
export const ui: Record<'en' | 'tr', Ui> = {
  ...
  tr: {
    ...
    heroTitle: 'Gözlerin bütün gün tek bir odakta kaldı.',
    heroLede:
      'Hareket eden bir noktayı takip et; kısa ve rehberli rutinler. Her egzersiz ne yaptığını, ne kadar sürdüğünü ve kanıtının gerçekte ne kadar güçlü olduğunu söylüyor. Önce okumana gerek yok. Başlat, uygulama seni adım adım götürür.',
    ...
    how: [
      {
        title: 'Başlat',
        text: 'Bir geri sayım, sonra tek tek talimatlar. Önceden okuman gerekmiyor.',
      },
      {
        title: 'Noktayı takip et',
        text: 'Başını sabit tut, sadece gözlerin gitsin. Hızı nokta belirler.',
      },
      {
        title: 'Denildiğinde dur',
        text: 'Her rutin dinlenmeyle biter. Bir şey ağrırsa veya baş dönerse dur. Bu uyarı her egzersizde var.',
      },
    ],

    routinesTitle: 'Rehberli rutinler',
    routinesHint: 'Arka arkaya birkaç egzersiz, süreleri senin için ayarlanmış. Buradan başla.',
    featuredTag: 'Buradan başla',
    exercisesTitle: 'Tek egzersizler',
    exercisesHint: 'Tek bir hareket, gerekçesi ve kaynaklarıyla.',
    exercisesCount: (count) => `${count} egzersiz`,
    goalTitle: 'Gözlerin neye ihtiyaç duyuyor?',
    goalAria: 'İhtiyaca göre süz',
    goals: {
    ...
    evidence: {
      trial: {
        ...
        hint: 'Kontrollü bir çalışma bu pratiği veya parçası olduğu diziyi ölçtü.',
      },
      clinical: {
        label: 'Klinik pratik',
        hint: 'Göz sağlığı uzmanları tanı almış belirli bir durum için reçete ediyor.',
      },
      mixed: {
        label: 'Kanıt ikiye bölünmüş',
        hint: 'İyi çalışmalar birbirini tutmuyor. İki taraf da aşağıda bağlantılı.',
      },
      traditional: {
        label: 'Geleneksel',
        hint: 'Yoga pratiğinden geliyor. Arkasında ölçüm yok veya çok az.',
      },
    },
    ...
    limitsTitle: 'Bunun yapabildikleri ve yapamadıkları',
    limits: [
      'Göz egzersizleri gözlük numarasını değiştirmez. Miyopi, hipermetropi, astigmat ve presbiyopi gözün fiziksel şeklinden ve yaşlanmasından kaynaklanır; hiçbir hareket bunu değiştirmez. American Academy of Ophthalmology bu konuda net; biz de öyleyiz.',
      'Muhtemelen yaptıkları şey: zorlanmayı ve kuruluğu hafifletmek, saatlerce tek pozisyonda kalan kasları gevşetmek ve odağın yakın ile uzak arasında daha kolay geçmesini sağlamak. Bunlar rahatlık kazanımları ve sahip olmaya değerler.',
      'Buradaki bir egzersiz gerçek bir tanı için gerçek bir tedavi: hedefi burna doğru getirmek, konverjans yetersizliğinin ev egzersizi. Çalışmada çocukların %43\u2019üne yardım etti; gözetimli terapi ise %73\u2019üne. Yakın iş düzenli olarak çiftleşiyor veya ağrıyorsa, kendi kendine tedavi yerine değerlendirme al.',
      'Gözlerin için yapabileceğin en güçlü desteklenen şey bu uygulamada hiç yok: açık havada vakit geçirmek. Üç yıllık bir çalışmada günde 40 dakika ek açık hava, çocuklarda yeni miyopiyi %39,5\u2019ten %30,4\u2019e düşürdü.',
    ],
    sourcesTitle: 'Kaynaklar',
    sourcesLede: 'Yukarıdaki her iddia bunlardan birinden geliyor. Aç ve kontrol et.',
    safetyTitle: 'Ne zaman durmalı',
    safety:
      'Baş dönmesi, bulantı veya biriken baş ağrısı olursa hemen dur. Yakın zamanda göz ameliyatı geçirdiysen, retina rahatsızlığın ya da göz enfeksiyonun veya yaralanman varsa, hekimin onaylamadıkça göz hareketi egzersizlerini yapma. Ani çift görme, ışık çakmaları, uçuşan cisimler, görüşün önüne perde inmesi veya görme kaybı acil durumdur. Bugün bir hekime git, uygulamaya değil.',
    disclaimer:
      'Bu bir öz bakım rehberidir, tıbbi tavsiye değildir ve hiçbir şeye teşhis koymaz. Görüşünü düzeltmez ve göz muayenesinin yerini almaz. Gözlerin ağrıyorsa, görüşün değişiyorsa veya şikayetler tekrarlıyorsa bir göz doktoruna git.',
    ...
    reminderTitle: 'Her 20 dakikada hatırlat',
    reminderBody:
      'Bu sekme açık kaldığı sürece, uzağa bakma zamanı geldiğinde sessiz bir şerit görünür. Göz sağlığı kuruluşlarının üzerinde anlaştığı tek alışkanlık bu.',
    reminderOn: 'Açık',
    reminderOff: 'Kapalı',
    reminderEvery: (minutes) => `Her ${minutes} dk`,
    reminderNudgeTitle: 'Uzağa bakma zamanı',
    reminderNudgeBody: 'Uzaktaki bir şeye yirmi saniye. İstenen tek şey bu.',
    reminderStart: 'Molayı al',
    reminderLater: 'Şimdi değil',
    reminderNext: (clock) => `Sıradaki hatırlatma ${clock} sonra`,
    ...
    evidenceNoteTitle: 'Ne kadar biliyoruz',
    setupTitle: 'Başlamadan önce',
    howToTitle: 'İyi yapmak için',
    bestForTitle: 'Şunlar için uygun',
    skipIfTitle: 'Şu durumlarda atla veya dur',
    planTitle: 'Plan',
    planHint: 'Bu sırayla, süreleri senin için ayarlanmış.',
    roundsTitle: 'Tur',
    ...
    prepTitle: 'Rahatına bak',
    prepBody:
      'Ekran yaklaşık bir kol mesafesinde ve göz seviyesinde. Başını sabit tut; sadece gözlerin hareket etsin. Gözlük kullanıyorsan tak.',
    nextUp: 'Sırada',
    ...
    pause: 'Duraklat',
    paused: 'Duraklatıldı',
    pausedBody: 'İhtiyacın kadar bekle.',
    resume: 'Devam et',
    skip: 'Atla',
    ...
    completeTitle: 'Gözler geri döndü.',
    completeBody: (name) =>
      `${name} tamamlandı. Oda bir an daha parlak ve net görünüyorsa, bu odak kasının bıraktığı andır.`,
    completeStreak: (days) => `Üst üste ${days} gün. Kısa tut, sık yap.`,
    repeat: 'Tekrar',
    chooseAnother: 'Başka bir şey seç',
    tipTitle: 'Yanında götüreceğin tek şey',
    tips: [
      'En iyi göz alışkanlığı sıkıcıdır: sık sık uzağa bak. Alışıldık tavsiye her yirmi dakikada bir.',
      ...
      'Gözlerin kuruysa, sık kırpmaktan çok tam kırpmak önemli. Kapaklar gerçekten birleşsin.',
      'Arkasında güçlü çalışma kanıtı olan tek müdahale açık havada vakit geçirmek; özellikle çocuklarda.',
      'Kuru hava gözü kurutur. Bir nemlendirici veya klima menfezinden uzaklaşmak her egzersizi yenebilir.',
      'Bu uygulamadan tek bir şey alacaksan, pencereden dışarı bakılan yirmi saniye olsun.',
    ],

    routines: {
      desk: {
        name: 'Bir Dakikalık Sıfırlama',
        tagline: 'En kısa işe yarar mola. İki kırpma seti ve uzun bir uzak bakış.',
        what: 'İki toplantı arasına sığar. Göz yüzeyini yeniden nemlendirir ve odak kasını yirmi saniye serbest bırakır.',
      },
      screen: {
        name: 'Ekran Molası',
        tagline: 'Masa başında geçen uzun bir süreyi geri almak için üç dakika.',
        what: 'Kırpma, uzak molası, yatay germe, odak değiştirme ve bitirmek için sıcak eller. Günlük seçenek.',
      },
      classic: {
        name: 'Klasik Göz Yogası',
        tagline: 'Çalışmadaki sekiz adımlı dizi, özgün sırasıyla.',
        what: 'Avuçlama, kırpma, yana bakış, ön ve yan, yukarı aşağı, daireler, başparmaktan buruna ve yakından uzağa. Kontrollü bir çalışmada göz yorgunluğu puanlarını düşüren dizinin tam olarak kendisi.',
      },
      mobility: {
        name: 'Tam Açıklık',
        tagline: 'Gözlerin gidebildiği her yön, sonra sıcak eller.',
        what: 'Düz hatlar, çaprazlar, daireler, bir sekiz ve bir kare. Kuru değil katı hissettiren gözler için.',
      },
      focus: {
        name: 'Odak Çalışması',
        tagline: 'Yakın, uzak ve içe: odak ve takım kasları.',
        what: 'Mesafe değiştirme, hedefi burna getirme ve hızlı sıçramalar. Buradaki en zorlayıcı rutin. Ağrırsa dur.',
      },
      'wind-down': {
        name: 'Yavaşlama',
        tagline: 'Günü kıs. Kırp, yumuşat, bak, dinlen.',
